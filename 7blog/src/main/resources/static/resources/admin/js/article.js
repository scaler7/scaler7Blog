...
function subArticle(status) {
    ...
    //var articleJson = {};
    var params = $("#articleForm").serialize(); //$("#articleForm").serializeArray()map(function(d){articleJson[d.name]=d.value;});
    var url = $('#articleForm #id').val() != '' ? '/admin/article/modify' : '/admin/article/save';
    $.ajax({
        url: url,
        type:'POST',
        data:params,
